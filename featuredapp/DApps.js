// from MASQ-web3-store Public repo - updated 28 Nov 2022
...
import feature1 from '../../../assets/images/dapps/dapp_feat2_crucible-resized.png';
import feature2 from '../../../assets/images/dapps/dapp_feat3_FlufWorld.png';
...
const DApps = () => {
  ...
  const handleClickFavorite = async (item, status) => {
      ...
      if (status) {
          ...
          console.log(20221124, 'add to favourites');
      }
   };
